...
public class CorrectPage {
	...
	public void task_10() {
		...
		if ((sizeRegularPriceString.getHeight() >= sizeCampaignPriceString.getHeight())
						|| (sizeRegularPriceString.getWidth() >= sizeCampaignPriceString.getWidth())) {
		...
		Dimension sizeCampaignPrice = driver.findElement(By.cssSelector
						("strong[class=campaign-price]")).getSize();
		if ((sizeRegularPrice.getHeight() >= sizeCampaignPriceString.getHeight())
						|| (sizeRegularPrice.getWidth() >= sizeCampaignPriceString.getWidth())) {
